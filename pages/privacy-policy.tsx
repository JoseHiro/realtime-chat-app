          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-base text-gray-600 leading-relaxed mb-4">
                Welcome to Kaiwa Kun ("we," "our," or "us"). We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Japanese learning platform.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-gray-900">2.1 Information You Provide</h3>
                  <ul className="list-disc pl-6 space-y-2 text-base text-gray-600">
                    <li>Account information (email address, username, password)</li>
                    <li>Conversation data (voice recordings, transcripts, conversation history)</li>
                    <li>Payment information (processed securely through Stripe)</li>
                    <li>Feedback and support communications</li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-gray-900">2.2 Automatically Collected Information</h3>
                  <ul className="list-disc pl-6 space-y-2 text-base text-gray-600">
            ...
            <section>
              ...
              <p className="text-base text-gray-600 leading-relaxed mb-4">We use the information we collect to:</p>
              <ul className="list-disc pl-6 space-y-2 text-base text-gray-600">
            ...
            <section>
              ...
              <p className="text-base text-gray-600 leading-relaxed">
                Your conversation data is stored securely and is only accessible to you and our system for the purpose of providing our services.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold mb-4 text-gray-900">5. Data Sharing and Disclosure</h2>
              <p className="text-base text-gray-600 leading-relaxed mb-4">We do not sell your personal information. We may share your information only in the following circumstances:</p>
              <ul className="list-disc pl-6 space-y-2 text-base text-gray-600">
                <li>With service providers who assist us in operating our platform (e.g., Stripe for payments, cloud hosting providers)</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-base text-gray-600">
                ...
                <li>Opt-out of marketing communications (you can manage this in your account settings)</li>
              </ul>
            ...
            <section>
              ...
              <p className="text-base text-gray-600 leading-relaxed mb-4">
                We use cookies and similar technologies to enhance your experience, analyze usage, and assist with security. You can control cookies through your browser settings, but disabling cookies may affect the functionality of our platform.
              </p>
            </section>
