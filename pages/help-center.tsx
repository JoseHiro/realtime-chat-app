...
import { ChevronDown, ChevronUp, BookOpen, Settings, CreditCard, MessageCircle } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Find answers to common questions and learn how to get the most out of Kaiwa Kun
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-12">
            ...
            >
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">How It Works</h3>
              <p className="text-sm text-gray-600">Learn about our platform and features</p>
            </Link>
            <Link
              href="/pricing"
              className="bg-white border border-gray-200 rounded-lg p-6 hover:border-gray-300 hover:shadow-md transition-all"
            >
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">Pricing</h3>
              <p className="text-sm text-gray-600">View our subscription plans</p>
            </Link>
          </div>
