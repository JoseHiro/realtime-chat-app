    ...
    <div className="max-w-5xl mx-auto py-4">
      <div className="flex justify-between items-center gap-2">
        ...
        <div className="bg-gray-100 dark:bg-gray-800 rounded-full p-2">
          <RiSpeakAiFill className="w-6 h-6 text-gray-700 dark:text-gray-300" />
        </div>
      </div>
        ...
        {levels.map((level) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-4">
                <div className="flex items-center gap-2 text-[10px] text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-2">
                  <span>Difficulty</span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1">
                  <div
                    className={`h-1 rounded-full transition-all ${
                      isSelected ? "bg-gray-900 dark:bg-gray-100" : "bg-gray-400 dark:bg-gray-500"
                    }`}
                    style={{
