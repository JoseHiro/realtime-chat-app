 ...
 * @param voiceProvider - Voice provider ("azure" or "elevenlabs")
...
export function calculateCreditsForChat(
  ...
  if (credits === undefined) {
    throw new Error(
      `Invalid combination: ${durationMinutes}min + ${voiceProvider}. Supported: 3min, 5min, 10min with azure or elevenlabs`
    );
  }
